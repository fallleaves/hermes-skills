...
④ **Write or update wiki pages:**
   ...
   - **Translation:** If sources are in a non-English language (e.g., Dutch),
     translate all content to English before writing wiki pages. Keep the original
     language version in the raw layer — the wiki itself is English.
